        ...
        <div class="container-fluid">
            ...
            <div class="main">
                ...
                <?php } else { ?>
                    <div class="mb-4">
                        <div class="d-flex justify-content-between">
                            <h2 class="fw-bold mb-4">Assistants</h2>
                            <div>
                                <a class="btn btn-primary" href="<?php echo $this->url("admin/assistants?create"); ?>">Create assistant</a>
                            </div>
                        </div>
                        <?php if ($flash = $this->flash()) { ?>
                            <div class="p-2 alert alert-<?php echo $flash['type']; ?>"><?php echo $flash['message']; ?></div>
                                            ...
                                            <tbody>
                                                <?php foreach ($assistants as $assistant) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <a href="<?php echo $this->url("admin/assistants?id=" . base64_encode($assistant['id'])); ?>" class="text-decoration-none" title="Edit">Edit</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
