        ...
        <div class="container-fluid">
            ...
            <div class="main">
                            ...
                            <div class="card border-0 p-3">
                                ...
                                <?php } else { ?>
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-sm border-0" href="<?php echo $this->url('admin/templates?id=' . $template['id'] . '&duplicate=' . md5($template['id'])) ?>" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Create duplicate">
                                ...
                                <form method="post" class="form post-form" novalidate>
                                    ...
                                    <div class="mb-5 collapse" id="collapseAdvance">
                                        ...
                                        <div class="mb-4">
                                            <label for="colorInput" class="form-label">Help text / Embed YouTube video (optional)</label>
                                    ...
                                    <div class="row mb-4 flex-row-reverse">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check mb-2">
                                                <input type="checkbox" name="premium" class="form-check-input" id="input-premium" <?php echo isset($template['premium']) ? ($template['premium'] == 1 ? 'checked' : null) : null; ?>>
                                                <label class="form-check-label" for="input-premium">Premium template</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input type="checkbox" name="landing" class="form-check-input" id="input-landing" <?php echo isset($template['landing']) ? ($template['landing'] == 1 ? 'checked' : null) : null; ?>>
                                                <label class="form-check-label" for="input-landing">Visible in landing page</label>
                                            </div>
                                            <div class="form-check mb-2">
                ...
                <?php } else { ?>
                    <div class="mb-4">
                        <div class="d-flex justify-content-between">
                            <h2 class="fw-bold mb-4">Templates</h2>
                            <div class="d-flex">
                                <div class="me-3">
                                ...
                                <div>
                                    <a class="btn btn-primary" href="<?php echo $this->url("admin/templates?create"); ?>">Add template</a>
                                </div>
                            </div>
                        </div>
                        <?php if ($flash = $this->flash()) { ?>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($templates as $template) { ?>
                                                            <tr class="templateRow">
                                                                ...
                                                                <td class="text-end"><a class="text-decoration-none" href="<?php echo $this->url("admin/templates?id=$template[id]"); ?>">Edit</a></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
                        ...
                        <?php } else { ?>
                            <div>Templates not available!</div>
                        <?php } ?>
                    </div>
                <?php } ?>
            </div>
