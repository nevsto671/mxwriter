    ...
    <div class="container">
      <div class="py-5">
        <div class="text-center py-5">
          ...
          <h4 class="fw-semibold mb-5">The page you are looking for is unavailable</h4>
          <a href="<?php echo $this->url(null); ?>" class="btn btn-primary fw-semibold px-4">Go to Home</a>
        </div>
      </div>
    </div>
  </main>
